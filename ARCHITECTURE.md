...
| **Сигнальные фильтры** | `spread_entry` | `0.008` (0.80%) | Минимальный требуемый чистый спред входа после вычета 2 комиссий входа |
| | `min_spread_entry` | `0.0015` (0.15%) | Нижний порог фактического чистого спреда налива (анкор лимита хеджа) |
...
| **Фаза 2: Валидация** | `phase2_lead_validation.min_notional_usd`| `$5.0` | Порог minNotional налитого объема Lead для возможности хеджирования |
...
| | `phase2_lead_validation.quarantine_model_drift_sec`| `3600` (1 час) | Карантин монеты при Model Drift |
| **Фаза 3: Hedge Leg** | `phase3_hedge_leg.decay_map` | `3 итерации (50, 150, 300мс)` | Адаптивный дожим хеджа с постепенной уступкой спреда |
| | `phase3_hedge_leg.min_hedge_fill_rate` | `0.75` (75%) | Минимальный процент налива хеджа для приемлемости связки |
| | `phase3_hedge_leg.quarantine_hedge_failed_sec` | `1800` (30 мин) | Карантин при сбое хеджирования (< 75% налива) |
